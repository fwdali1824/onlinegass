...
<body>
        ...
        <ul class="nav flex-column">
            ...
            <li>
                <a href="{{ route('sales.orderList') }}"
                    class="nav-link {{ request()->routeIs('sales.orderList') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('sales.profile') }}"
                    class="nav-link {{ request()->routeIs('sales.profile') ? 'active' : '' }}">
    ...
    <div class="main-content p-2">
        <div class="d-flex align-items-center justify-content-between p-3 bg-light">
            <div>
                <h6 class="mb-0 text-muted">Sales Dashboard</h6>
    ...
    <div class="bottom-nav d-md-none">
        ...
        {{-- <a href="{{ route('sales.reports') }}" class="nav-link {{ request()->routeIs('user.chat') ? 'active' : '' }}">
            <i class="bi bi-journal"></i> Reports
        </a> --}}
        <a href="{{ route('sales.profile') }}"
            class="nav-link {{ request()->routeIs('sales.profile') ? 'active' : '' }}">
            <i class="bi bi-person-circle"></i> Profile
