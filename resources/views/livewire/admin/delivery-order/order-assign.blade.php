                ...
                <div class="modal-dialog">
                    <div class="modal-content h-100 profileDetail">
                        <div class="modal-header">
                            <h5 class="modal-title" style="color: black;">Order Detail</h5>
                        ...
                        <div class="modal-body overflow-auto">
                            ...
                            <h5 style="color: black;">Product Detail</h5>
                            ...
                            <br><br>
                            <h5 style="color: black;">Assign To Delivery</h5>
                            <form wire:submit.prevent="assignDelivery">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" wire:model="deliveryPersonId">
                                        ...
                                        @if ($productList->status == 'out_for_delivery')
