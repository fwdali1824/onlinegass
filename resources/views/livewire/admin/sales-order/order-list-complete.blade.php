<div class="col-lg-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary"
                                        wire:click="openModalProfile({{ $item->product_id }})">
    ...
    @if ($showModalSingle && $productList)
            ...
            <div class="modal-dialog">
                <div class="modal-content h-100 profileDetail">
                    ...
                    <div class="modal-body overflow-auto">
                        <img src="{{ $productList->product->image ?? $dummyImage }}" alt="Profile" width="150"
                            height="150" style="border: 1px solid gray;"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Total</th>
                                <td>{{ $productList->total_amount }}</td>
                            </tr>
                            <tr>
                                <th>Order ID</th>
                        ...
                        <form wire:submit.prevent="assignDelivery">
                            <div class="form-group">
                                ...
                                <select class="form-control" wire:model="deliveryPersonId">
                                    <option value="">Please Select</option>
                                    @foreach ($userDelivery as $person)
